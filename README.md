...
### 背景(製品開発のきっかけ、課題等)
視覚障害の方は目の情報である90%がないため大変困難です。そこで視覚障害向けの歩行を支援するアプリは開発されています。
...
すでに買い物を補助するアプリは存在しています。しかしこのアプリでは**すでに登録した情報**をもとに支援します。これではどの店舗でも支援することは不可能です。いかに既存の商品購入支援アプリを設定。
...
3. ![image](https://github.com/user-attachments/assets/c51418c1-ded0-46e4-8f02-51ac74a40ead)
